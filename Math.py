...
print("ceil(4.4) = ", math.ceil(4.4))  #arrondi a la valeur sup
print("floor(4.4) = ", math.floor(4.4)) # arrondi a la valeur inf
print("fabs(-4.4) = ", math.fabs(-4.4)) # donne la valeur absolue

print("factorial(4) = ",math.factorial(4)) #m ultiplie jusqu'aux nombre donner 1*2*3*4
